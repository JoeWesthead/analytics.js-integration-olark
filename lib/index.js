 ...
 * https://www.olark.com/api#api.chat.setOperatorGroup
 * https://www.olark.com/api#box.inline
 * https://www.olark.com/api#system.is_single_page_application
 *
 * @api public
 */
...
Olark.prototype.initialize = function() {
  ...
  // load the chat box inside a container
  // with ID "olark-box-container"
  var inline = this.options.inline;
  if (inline) configure('box.inline', true);

  // prevent Olark polling requests from timing out
  // for Single-Page Applications
  var spa = this.options.spa;
  if (spa) configure('system.is_single_page_application', true);
...
/**
 * Helper for Olark API configuration
 *
 * @api private
 * @param {string} action
 * @param {Object} value
